      ...
      <div className={cssClasses.textBg}>
        <div className={cssClasses.textCanvas}>
          ...
          <p>
            ...
            me to write some study blogs on maths, physics and programming. I do
            feel like I can understand the topics way better and get new
            insights when I am trying to reproduce new concepts I learnt. Wish I
            am not too lazy or busy so I can keep friends and peers updated.
          </p>
          <p>
            This website was run on Next.js framework. The source code was put
            on GitHub then fetched and deployed by Vercel, which is the
            recommended method for Next.js project.
          </p>
          <p>
            ...
            year as well. There are a few other details in the choice so try to
